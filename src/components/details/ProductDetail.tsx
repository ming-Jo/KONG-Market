...
const ProductDetail = () => {
  ...
  return (
    <div>
      ...
      <strong className="block text-[3rem] font-normal mt-4 mb-6">{detail?.product_name}</strong>
      ...
      <p className="py-6 text-dark-gray">
        ...
        {detail?.shipping_fee === 0 ? '무료배송' : `배송비 ${detail?.shipping_fee.toLocaleString('ko-KR')} 원`}
      </p>
    </div>
  );
};
