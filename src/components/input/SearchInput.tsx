...
const SearchInput = () => {
  return (
    <form className="w-[40rem] ml-[3rem]">
      <fieldset className="flex justify-between items-center relative">
        ...
        <input
          ...
          className="w-full px-[2.2rem] py-[1.2rem] text-[1.6rem] bg-light-choco rounded-full border-2 border-main-choco"
        />
        <button
          type="button"
