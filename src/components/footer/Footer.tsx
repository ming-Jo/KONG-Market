...
const Footer = () => {
  const footerList = ['콩마켓 소개', '이용약관', '개인정보처리방침', '전자금융거래약관', '청소년보호정책', '제휴문의'];
    ...
    <footer className="py-16 bg-light-gray">
      <div className="max-w-[138rem] px-20 mx-auto text-[1.4rem]">
        ...
        <div className="mt-12 leading-10 text-dark-gray">
          ...
          <address className="not-italic">제주특별자치도 푸들시 땅콩로 123-45</address>
          <dl className="flex">
            <dt>사업자등록번호</dt>
            <dd className="before:content-[':'] before:inline-block before:px-2">000-00-00000</dd>
            <dd className="before:content-['|'] before:inline-block before:px-2">통신판매업</dd>
          </dl>
          <dl className="flex">
            <dt>대표</dt>
            <dd className="before:content-[':'] before:inline-block before:px-2">조민지</dd>
          </dl>
        </div>
      </div>
    </footer>
